...
public class UserProfileActivity extends AppCompatActivity
{
    ...
    public static final String DATA_EXISTING_USERNAME
            = "com.whoselineisitanyway.DATA_EXISTING_USERNAME";
    ...
    ArrayList<Rating> ratings;
            // Get a list of ratings from the rating collector - is there a more OOP way to do this?
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            Log.i("UserProfileView",
                    "No user data was passed to the activity via intent! tag it with EXISTING_USER!");
            Toast.makeText(this, "There was an error and the user couldn't be shown.",
                    Toast.LENGTH_SHORT).show();
            finish(); // Exit the intent, there was an irrecoverable error
        }

        usernameField = findViewById(R.id.txt_userName);
        contactField = findViewById(R.id.txt_contact);
        ratingSummary = findViewById(R.id.txt_reviewHeader);
        ratingList = findViewById(R.id.lst_reviews);
        ...
        ratingSummary.setText(
                reviews.toString()); // This gets the general summary (5 reviews, 5 stars, blah blah and sets it as text
    ...
    private String columnarizeText(String input, Integer len)
    {
        ...
        {
            len = 25;
        } // This can be adjusted if deemed appropriate, but make it a optional
        if (input.length() > len)
        {
            return input;
        }
