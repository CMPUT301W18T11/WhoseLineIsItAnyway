 ...
 * @version 2.0
 */
public final class TaskCopy implements Detailed, Serializable
{
    /**
     ...
     * @see TaskStatus
     */
    private TaskCopy(@NonNull final String requesterId,
                     ...
                     @NonNull final TaskStatus status)
    {
        ...
        if (title.length() > TaskCopy.MAXIMUM_TITLE_LENGTH)
        {
            throw new IllegalArgumentException(
                    String.format(Locale.getDefault(), "title cannot exceed %d characters",
                            TaskCopy.MAXIMUM_TITLE_LENGTH));
        }

        if (description.length() > TaskCopy.MAXIMUM_DESCRIPTION_LENGTH)
        {
            throw new IllegalArgumentException(
                    String.format(Locale.getDefault(), "description cannot exceed %d characters",
                            TaskCopy.MAXIMUM_DESCRIPTION_LENGTH));
        }
     ...
     * @param description The task's description.
     */
    public TaskCopy(@NonNull final String requesterId,
                    @NonNull final String title, @NonNull final String description)
    {
     ...
     */
    @NonNull
    public final TaskCopy submitBid(@NonNull Bid bid)
    {
        ...
        {
            case REQUESTED:
                return new TaskCopy(this.getRequesterId(), new Bid[]{bid},
            ...
            case BIDDED:
                ...
                return new TaskCopy(this.getRequesterId(), bids.toArray(new Bid[0]),
                        this.getTitle(), this.getDescription());
     ...
     */
    @NonNull
    public final TaskCopy assignProvider(@NonNull String providerId)
    {
        ...
        return new TaskCopy(this.getRequesterId(), providerId, this.getBids(),
     ...
     */
    @NonNull
    public final TaskCopy markDone()
    {
        ...
        return new TaskCopy(this.getRequesterId(), providerId, bids, this.getTitle(),
